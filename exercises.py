...
def calculate_area_triangle (base, ht) :
    return (base * ht) / 2
...
def simple_interest (princ, roi, years):
    return(princ*roi*years)/100
...
print('Exercise 6:', largest(10, 7, 3))
...
print('Exercise 7:', calculate_tip(70, 15))
...
def basicCalculator(num1, num2, *args):
    for arg in args:
        if arg == 'add':
            return num1 + num2
        elif arg == 'subtract':
